...
17. 文明在进化 然而我们始终带着原始的兽性 平地上 人们筑起万丈高楼 不过是一座座 摩天动物园。
...
27. Spatial Web(空间网络)将最终消除我们今天所知道的数字内容和物理对象之间的边界。
...
28. Web3 思维是基于天真的技术官僚假设，认为技术和"聪明的想法"可以解决我们的大部分社会问题。
...
29. Qualities of a good manager share a lot of qualities of a good engineer.
...
30. How to help someone get promoted.

相关

- [An incomplete list of skills senior engineers need, beyond coding](https://skamille.medium.com/an-incomplete-list-of-skills-senior-engineers-need-beyond-coding-8ed4a521b29f)

31. 墨菲定律：Anything that can go wrong will go wrong.

相关

32. Be liberal in what you accept, and conservative in what you send.

相关

- [Jon Postel](https://somanymachines.com/tx/character-generator-protocol/)

33. Break down skills by proficiency: Instead of breaking down your skills by category (e.g. Databases, Frameworks, Networking). It's usually better to break it down by proficiency (e.g., Familiar with, Experienced in .). Here's how it looks like in real life:
...
34. The probability of being able to outperform increases with patience.
