...
- Finally, <Highlight>use the experience to learn. Consider what part you played in the decision not going your way, and solicit feedback about what you could have done better</Highlight>. People are often willing to be honest when they think your request to improve is sincere. And ideally, you can use that input the next time you take on a similar challenge.
